...
const stallDetailState = atom({
  ...
  default: [
    { id: 1, Name: "Chicken Pizza", image: "/1.png", Price: 220.0 },
    { id: 2, Name: "Margherita Pizza", image: "/2.png", Price: 150.0 },
    {
      id: 3,
    ...
    { id: 6, Name: "Salted Fries", image: "/6.png", Price: 120.0 },
    { id: 7, Name: "Peri Peri Fries", image: "/7.png", Price: 140.0 },
    {
      id: 8,
